"""
Mask R-CNN
Train on the Balloon robot dataset.
...
Usage: import the module (see Jupyter notebooks for examples), or run from
    ...
    python Balloon.py train --dataset=/home/.../mask_rcnn/data/Balloon/ --weights=coco

    #Train a new model starting from pre-trained ImageNet weights
    python Balloon.py train --dataset=/home/.../mask_rcnn/data/Balloon/ --weights=imagenet

    # Continue training the last model you trained. This will find
    # the last trained weights in the model directory.
    python Balloon.py train --dataset=/home/.../mask_rcnn/data/Balloon/ --weights=last
    ...
    python Balloon.py splash --weights=last --image=/home/...../*.jpg

    #Detect and color splash on a video with a specific pre-trained weights of yours.
    python sugery.py splash --weights=/home/.../logs/mask_rcnn_Balloon_0030.h5  --video=/home/simon/Videos/Center.wmv
"""
...
class BalloonConfig(Config):
    ...
    NUM_CLASSES = 1 + 2  # Background + Number + Reflection  ##change1
...
class BalloonDataset(utils.Dataset):
    def load_VIA(self, dataset_dir, subset, hc=False):
        """Load the Balloon dataset from VIA.
        dataset_dir: Root directory of the dataset.
        subset: Subset to load: train or val or predict
        """
        # Add classes. We have only one class to add.####  ##change2
        self.add_class("balloon", 1, "claw")
        self.add_class("balloon", 2, "connection")
        ...
        for a in annotations:
            ...
            # name_dict = {"Number":1,"Reflection":2}
            names = [r['region_attributes'] for r in a['regions'].values()]#
            name = [r['region_attributes']['class'] for r in a['regions'].values()] #change
            name_dict = {'claw':1, 'connection':2}##change
    ...
    def load_mask(self, image_id):
       ...
       Returns:
        ...
        # In the Balloon dataset, pictures are labeled with name 'a' and 'r' representing arm and ring.
        for i, p in enumerate(class_names):
        #"name" is the attributes name decided when labeling, etc. 'region_attributes': {name:'a'}##change
            if p['class'] == 'claw': ##change
                class_ids[i] = 1
            elif p['class'] == 'connection': ##change
                class_ids[i] = 2
...
def detect_and_color_splash(model, image_path=None, video_path=None, out_dir=''):
    ...
    class_names = ['claw', 'connection']##change
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', required=False,
                        metavar="/home/simon/mask_rcnn/data/Balloon",
